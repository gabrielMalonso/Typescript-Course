...
- **11 — Set, Map e hashing:** em andamento. CS50 Dictionaries/Hashing, CLRS 11.1 e parte conceitualmente relevante de 11.2 concluídos conforme relato em 16/09/2026, com compreensão consolidada por explicação guiada. Exercício 11.2-2 de chaining concluído; [entrega preservada](11-set-map-e-hashing/pratica/respostas.md) inspecionada: posições e cadeias com inserção no início corretas. Não exigir releitura. Aulas de Set/Map preparadas; domínio prático dessas APIs ainda não avaliado. Continuação em [estado atual](.context/estado-atual.md). Formalismo opcional; nenhum avanço ao 12.
