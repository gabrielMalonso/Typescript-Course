...
**Próximo passo único:** abrir a [etapa 3 do Guia de estudo](../11-set-map-e-hashing/README.md#etapa-3) e ler a aula [**Set: representar presença**](../11-set-map-e-hashing/02-aulas-do-curso/01-set.md), executando os exemplos antes do experimento de Set. Não começar Map ou o capítulo 12 agora.
...
Curadoria e retomadas em [notas-professor.md](notas-professor.md); conhecimentos disponíveis em [historico-avaliacoes.md](historico-avaliacoes.md).
