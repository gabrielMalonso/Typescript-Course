...
- Continuação prática: MDN Description/igualdade e métodos essenciais de Set/Map, com comparação Objects vs. Maps delimitada. Verificados em 16/09/2026. Nota autoral cobre tipagem, escolhas Array/Set/Map/Object e hipóteses de custo; nenhuma solução dos LeetCodes é fornecida. A prática de frequências fica em Valid Anagram; não acrescentar outro exercício equivalente apenas para aumentar a lista.
...
Aceitar feedback parcial após atividade 2. Essenciais 2–6 cobrem API/identidade, presença, ausência versus valor válido, índice associado e frequências. Colisões/carga já foram estudadas e serão relacionadas às decisões sem repetir a leitura. Consolidação 7 e desafio 8 não bloqueiam sem lacuna essencial. Não atribuir Accepted ou execução independente sem evidência.
