# Evidências para orientar o próximo conteúdo

Atualizado em 2026-09-16. Este arquivo mantém apenas a base útil ao ensino atual; o nome do arquivo foi mantido para preservar referências existentes. Resultados detalhados ficam nas correções dos capítulos e em [PROGRESSO.md](../PROGRESSO.md).

## Conhecimentos disponíveis

- Base de TypeScript: condições, loops, arrays, objetos, funções e callbacks. A [prática do 09](../09-arrays-metodos-avancados/exercicios/correcoes.md) confirma uso de métodos de arrays, referências/cópias e closures.
...
- No 11, Gabriel relata estudo concluído dos trechos CS50 Dictionaries/Hashing e CLRS 11.1/parte conceitual de 11.2: endereçamento direto, espaço, hash, colisões, chaining, carga intuitiva e custo esperado versus pior caso. A explicação guiada consolidou o trecho denso de 11.2; a entrega de chaining foi inspecionada, com resultado registrado no [PROGRESSO](../PROGRESSO.md). Set/Map ainda não têm domínio prático avaliado; provas probabilísticas não são exigidas.
